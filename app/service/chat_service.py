...
class ChatService:
        ...
        async def receive_messages():
            try:
                while True:
                    ...
                    await self.process_and_send_message(channel_id, message)
    ...
    async def process_and_send_message(self, channel_id: int, message: str):
        processed_message = await self.process_message(message)
        await self.pubsub_service.send_message(channel_id, processed_message)
